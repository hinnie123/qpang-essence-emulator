...
public:
	WhisperReceivedEvent(std::u16string nickname, std::u16string message) { _nickname = nickname; _message = message; }

	ServerPacket Compose(LobbySession* session) override 
	{
		auto packet = ServerPacket::Create<Opcode::LOBBY_WHISPER>();
